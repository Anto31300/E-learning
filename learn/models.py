...
class Course(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)  # Price of the course
...
class Student(models.Model):
    ...
    purchased_courses = models.ManyToManyField('Course', related_name='purchasers', blank=True)  # Courses purchased by the student
